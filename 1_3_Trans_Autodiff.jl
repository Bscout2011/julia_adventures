...
# ╔═╡ ea7f7ec8-32d1-414b-aadb-483db4119a5e
f₂(x)=x^3

# ╔═╡ b53c7ad6-b257-4249-b3a3-bcebdec536e3
f₂(3)
...
# ╔═╡ 42ae1b71-8fb5-49de-b0c9-99abb74fca00
my_thing = x->sin(x)

# ╔═╡ 8f786d95-f89c-43be-9567-0f1e54b29a2e
my_thing(π/4)
...
ForwardDiff.derivative(f₁, 10) # remember f₁ is x^2, do derivative is 2x
...
begin
	...
	f₅(x,y,z) = 5sin(x*y) + 2*y/4z          # function of multiple components
end
...
md"""
What is this thing? Derivative is scalar to scalar. Gradient is scalar to vector. Jacobian is a vector to vector.
"""
...
Linear transformations make the grid lines *congruent parallelograms*. The determinant is the scaling factor for the area after the transformation.
