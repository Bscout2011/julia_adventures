...
# ╔═╡ c6d943b6-3e39-47e3-9d00-a1ed97025f07
md"""
Start from the minimum below. Then iterate upward. "Overlapping subproblems". Solving the problem from the top-down.
"""
...
# ╔═╡ 00194a9c-8519-42d4-9389-0a50c2d3ec14
values
...
# ╔═╡ d8088d9d-7dff-4002-a75e-94e416f9376f
allvals = [sum( M[i,p[i]] for i=1:n) for p∈paths]

# ╔═╡ 3fcb1ee5-2822-42e1-98dc-d0dbb66d87f9
histogram(allvals)

# ╔═╡ 75eea07d-f33b-41fc-9d7f-3797dd80b16a
paths
