...
# T⁻¹ = id
 # T⁻¹ = rotate(α)
  ...
  # T⁻¹ = shear(α) ∘ shear(-α)  # this operation does nothing!
 # T⁻¹ = nonlin_shear(α)  
...
# T⁻¹ = ((x,y),) -> (sin(α*x), cos(α*y))
# T⁻¹ = ((x,y),) -> (x + α*y^2, y + α*x^2)
...
# 		Good computer scientists create functions that generalize well.
# 		Naive Engineers hardcode everything in... Kind of like my classifier.
# 		No longer about getting the answer right. It's about doing it with style.
