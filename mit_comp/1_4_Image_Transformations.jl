...
# ╔═╡ 4570f60a-e0e8-4aa8-ba45-d2dccba548d5
uconvert( u"J",PotentialEnergy) / 10u"s"
...
# ╔═╡ 8e360137-563d-44ff-a5ee-24ebd3d3156a
joinpath(pwd(), "poppy1.jpg")

# ╔═╡ 516e73e2-74fb-11eb-213e-9dbd9472e0db
philip =  load("/home/alw/data/poppy1.jpg")

# ╔═╡ 89ee9da2-ae16-46c3-a0b5-919b9db5d56e
poppy = philip[600:1600, 400:1300]

# ╔═╡ b5d0ef90-74fb-11eb-3126-792f954c7be7
@bind r Slider(1:40, show_value=true, default=40)

# ╔═╡ 754c3704-74fb-11eb-1199-2b9798d7251f
downsample_philip = poppy[1:r:end, 1:r:end]
...
c .* poppy  # scaling the corgis changes intensity
...
# ╔═╡ 6c8ce869-459c-4f8b-a9a7-a3832c5afa5c
upside_down_poppy = poppy[end:-1:1, :]
...
# ╔═╡ 35519840-ee3f-4888-8ae6-fe809efb50a6
md"""
All these filters are examples of *convolutions*.
"""
...
begin
	...
	sharpen2 = 2 .* identity .- box_blur
	∇x = [-1 0 1;-1 0 1;-1 0 1]/2 # centered deriv in x
	∇y = ∇x'
	
	kernels = [identity, edge_detect, sharpen, sharpen2, box_blur, ∇x, ∇y]
	kernel_keys =["identity", "edge_detect", "sharpen", "sharpen2", "box_blur", "∇x", "∇y"]
...
[imfilter( poppy, kernelize(kernel_matrix[kernel_name])) Gray.(1.5 .* abs.(imfilter( poppy, kernelize(kernel_matrix[kernel_name])))) ]
...
# ╔═╡ f8c8ce61-1a82-4458-8ad1-9f39622c7ecc
kernel
